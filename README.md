...
### About
- Currently working on [Platform X](https://github.com/CAPELLAX02/X-API), a comprehensive backend project for a social media application where I attempt to reverse engineer the backend of the Platform X, FNA Twitter. I want to push the boundaries of the monolithic server design in this project.
